 ...
 * ITs.
 *
 * <p>This is the titan-pipeline-model copy used by the parser unit tests. The titan-server copy
 * (under {@code src/integrationTest/}) serves the engine ITs. Keeping two thin copies avoids a
 * shared test-fixtures publication purely for one helper class.
 */
